...
class StylemetricAnalyzer:
    ...
    def __init__(self, nlp_model):
        ...
        self.function_words = {
            ...
            'after', 'my', 'than', 'first', 'been', 'who', 'its', 'now',
            'people', 'may', 'down', 'day', 'get', 'use', 'man', 'new',
            'way', 'could', 'does', 'only', 'where', 'most', 'over', 'think',
            'also', 'back', 'work', 'life', 'why', 'go', 'should', 'even'
        }

...
def cache_gpt2_model():
    ...
    logger.info("=" * 60)
    logger.info("Starting GPT-2 model caching process")
    logger.info("=" * 60)
    ...
    try:
        ...
        logger.info("=" * 60)
        logger.info("Model and tokenizer are now cached locally")
        logger.info("Cache location: ~/.cache/huggingface/transformers/")
        logger.info("Future loads will be much faster!")

...
class TestStylemetricAnalyzer:
    ...
    def test_comma_ratio_calculation(self, analyzer):
        ...
        text = "Hello, world! How, are, you?"  # 3 commas, 4 total punct
...
class TestIntegration:
    ...
    def test_stylometric_analysis_tool(self, mock_analyzer, mock_baseline_manager, mock_nlp):
        ...
        mock_features = {
            ...
            "sentence_positions": [
                {"position": 1, "length": 18, "text": "Test sentence."}
            ],
...
class TestAIDetectionAccuracy:
    ...
    def test_ai_text_classification(self):
        ...
        # AI-like features: low TTR, low hapax rate, uniform sentence lengths
        ai_features = {
            "avg_sentence_len": 15.0,
            "sentence_len_std": 2.0,  # Very uniform
            "ttr": 0.35,  # Low diversity
            "hapax_legomena_rate": 0.25,  # Low hapax rate
            "pos_ratios": {"NOUN": 0.23, "VERB": 0.16}
        }
